<?php
ob_start();
define('API_KEY','5850631752:AAGqYGf-nZ-twK7qHBUf7c7ZfPBODvn79fo');
$admin="5881842891";
...
'keyboard'=>[
    [
     ['text'=>"🔎 Dorini topish"],
     ['text'=>"🔗 Referal silkani tarqatish"],
     ['text'=>"🎯 botni admini"]
],
[
     ['text'=>"📱 Telefon raqami"],
...
[$name](tg://user?id=$cid) 
*siz bizning botimizga xush kelibsiz
Agar Sizga dori kerak bolsa ishlating agar bilmasangiz video bor orqali organing dorini nomini yozing va mahsulotimiz yordam teganimidan xursandman: * 
*Dasturchi*[@musulmon_0403]";
...
bot('sendMessage',
['chat_id'=>$cid,
'text'=>"Togri foydalaning iltimos🙏",
]);
}else{
$id="$cid\n";
...
bot('sendMessage',
['chat_id'=>$refid,
'text'=>"Dori kerak bolgan insoningizni taklif qiling🧑👩‍🦳",
'reply-markup'=>$key,
]);
}
}
...
bot('sendmessage',
['chat_id'=>$cid,
'text'=>"_📩Iltimos xabaringiz yozib qoldiring📩:_",
'parse_mode'=>'markdown',
'reply_markup'=>$key3,
]);
}
...
bot('sendmessage',
['chat_id'=>$cid,
'text'=>"_🔔Xabar ketdi savol uchun rahmat?.........\n📤Xabar jonatildi. Iltimos sabr qiling. Bot admini ozi yozadi sizga😉",
'parse_mode'=>'markdown',
'reply_markup'=>$key3,
]);
bot('sendmessage',
['chat_id'=>$admin,
'text'=>"Yangi xabar 🏃‍♂️ 
🧑👩‍🦳Xabar yuborgan banda: [$name] 
🔗Xabarchining xavolasi:@$yuzer 
🆔Xabar yuborgan bandaning idsi: $cid 
💻Xabar matini: $tx",
'parse_mode'=>'markdown',
'reply_markup'=>$key,
]);
...
bot('sendMessage',
['chat_id'=>$cid,
'text'=>"🌐Botlarimiz👉 @Saidbek_med_pharmbot",
'reply_to_message_id'=>$mid,
'reply_markup'=>$key,
]);
}
...
bot('sendMessage',
['chat_id'=>$cid,
'text'=>"Reklama qilish namuna boyicha qiling\n
Namuna: BOT🌐 
100 
Azo [Bot nomi](https://t.me/link) 
Agar notogri qildingiz reklama ochdi muammo bolsa adminga murojaat qiling",
'reply_to_message_id'=>$mid,
'reply_markup'=>$key3,
]);
...
bot('sendMessage',
['chat_id'=>$cid,
'text'=>"😈Sabrsizlingiz uchun 50 sum jarima!",
'reply_to_message_id'=>$mid,
]);
$sum-=50;
...
'message_id'=>$mid,
'parse_mode'=>'markdown',
'text'=>$tx."\n\n 👱‍♂️Reklama qilgan banda [$name](tg://user?id=$cid)",
...
'text'=>$tx."\n *💫Manba* [$botimiz]\n*Reklama qilindi✅* 
[$botimiz] *ga qarang👁* 
*Agar nimadur bolsa👨‍💻*[@musulmon_0403] *Botimizga murojaat qiling💻*",
'reply_markup'=>$key,
]);
bot('sendMessage',
['chat_id'=>$botimiz,
...
'inline_keyboard'=>[
[
 ['text'=>"📝Reklama berish",'url'=>"https://t.me/Saidbek_med_pharmbot"]
]
]
])
]);
...
'message_id'=>$mid,
'parse_mode'=>'markdown',
'text'=>"📤Xush kelibsiz, Botdan foydalanama olmaganlar pastda malumot bor👇
1-Usul.
*🔗Referal silka* tugmani bosing keyin bot sizga havola beradi siz uni yaqinlaringizga tarqatib har bir odamga 500 sum olasiz. 
2-Usul 
Botimizga kirganizda havola beradi tarqatganizga 500 sum olasiz va hato qilsangiz 50 sum jarima olasiz Guruhingiz yoki kanalingiz reklamasi [$botimiz] da elon qilmaymiz.",
'reply_to_message_id'=>$mid,
'reply_markup'=>$key,
]);
}
...
$sum=file_get_contents("sum/$cid.dat");
$in="📤Xush kelibsiz 
*Sizning toplangan jami summalaringiz: $sum sum mavjud* 
*🧑👩Yaqinlaringizni taklif qiling*"; 
bot('sendMessage',
['chat_id'=>$cid,
'message_id'=>$mid,
'parse_mode'=>'markdown',
...
'parse_mode'=>'markdown',
'text'=>"*Sum olish*💵 
_Agar sumga dori olmoqchi bolsangiz kartamizga tashlang_
*Pul tolash usullari* 
💳Click 
Sumga dori olish uchun siz #sum kerakli sumni yozing",
'reply_to_message_id'=>$mid,
'reply_markup'=>$key,
]);
}
...
'inline_keyboard'=>[
[
['text'=>"Botimiz", 'url'=>"https://t.me/Saidbek_med_pharmbot"],
]
]
])
]);
...
"\n🙎‍♂️Kerakli banda soni:
".$ex[1].
"\n🚦Boshqa bot qoshmay turing bot aytgach qo'shasiz!",
'reply_markup'=>$key,
]);
}
...
bot('sendMessage',
['chat_id'=>$cid,
'text'=>"💎Siz biz bergan vazifalarni bajarish keyin tasdiqlash✅tugmasini bosing👉$bot-bot",
'reply_markup'=>json_encode(
['resize_keyboard'=>true,
'keyboard'=>[
[['text'=>"Tasdiqlash✅"],],
...
bot('sendMessage',
['chat_id'=>$cid,
'text'=>"👆Siz bu botda bor edingiz!",
'reply_markup'=>$key,
]);
}else{
$get=file_get_contents("bot.dat");
list($odam,$bot,$now)=explode('|',$get);
$gett=bot('getCharMember',
['chat_id'=>$bot,
'user_id'=>$cid,
]);
$gget=$gett->result->status;
...
bot('sendMessage',
['chat_id'=>$cid,
'text'=>"❌Qaytadan urinib ko'ring, xato aniqlandi",
'reply_markup'=>$key,
]);
}
}else{
...
bot('sendMessage',
['chat_id'=>$usri,
'text'=>"😈Siz 5 kun bolmasdan [$chati] botdan chiqib ketdingiz Sizdan 50💵 sum olib tashlandi",
'reply_markup'=>$key,
]);
...
'message_id'=>$mid,
'parse_mode'=>'markdown',
'text'=>"📤Xush kelibsiz siz botimizda azo emassiz shuning uchun bot ishlamaydi*⛔️
_Botimizdan toliq foydalanish uchun_[$botimiz]_ga azo boling_✅",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"🌐Botimiz",'url'=>"https://t.me/Saidbek_med_pharmbot"],
]
...
bot('sendMessage',
['chat_id'=>$cid,
'text'=>"✉️Xabarni kiriting",'reply_markup'=>json_encode([
'resize_keyboard'=>true,
'keyboard'=>[
[
['text'=>"$orqaga"],],
