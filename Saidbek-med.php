<?php
ob_start();
define("API_KEY","5850631752:AAGtvPnZhiqcTtWY1OXCB_aTbhgMdFTfwfU");
$admin="5881842891";
...
[['text'=>"📱Telefon raqami"],['text'=>"📩Adminga yozing"],],
]
]);
$orqaga="🗄Menu";
$key3=json_encode(
...
2-Usul 
Botimizga kirganizda havola beradi tarqatganizga 500 sum olasiz va hato qilsangiz 50 sum jarima olasiz Guruhingiz yoki kanalingiz reklamasi [$botimiz] da e'lon qilmaymiz.",
'reply_to_message_id'=>$mid,
'reply_markup'=>$key,
]);
}
...
$sum=file_get_contents('sum/$cid.dat');
$in="📤Xush kelibsiz 
*Sizning to'plangan jami summalaringiz: $sum sum mavjud* 
...
'parse_mode'=>'markdown',
'text'=>"*Sum olish*💵 
_Agar sumga dori olmoqchi bo'lsangiz kartamizga tashlang_
*Pul to'lash usullari* 
💳Click 
